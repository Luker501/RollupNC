...
// for each proof, update 2**m transactions
    ...
    for (var i = 0; i < 2**m - 1; i++) {
        ...
        // transactions existence and signature check   //**We will need this!
        ...
        // sender existence check      //**Not sure if we need this?
        ...
        // balance checks      //**Not sure if we need this
        ...
        // subtract amount from sender balance; increase sender nonce    //**we will need something like this 
        ...
        // get intermediate root from new sender leaf       //**we will need this?
        ...
        // add amount to receiver balance   //** we shouldn't need this
        ...
        // get intermediate root from new receiver leaf //**so we shouldnt need this also
